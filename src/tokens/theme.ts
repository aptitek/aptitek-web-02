...
/**
 * Canonical 16-color Solarized Color Palette
 */
export const SOLARIZED = {
  base03: "#002b36", // Darkest background
  base02: "#073642", // Dark background highlights / paper / surface container
  base01: "#586e75", // Dark secondary / comments
  base00: "#657b83", // Dark body text / light body text
  base0: "#839496", // Dark primary text
  base1: "#93a1a1", // Dark emphasized / light secondary
  base2: "#eee8d5", // Light background highlights / paper / surface container
...
export const darkThemeOptions: ThemeOptions = {
  ...
  palette: {
    ...
    primary: {
      main: SOLARIZED.blue,
      light: SOLARIZED.cyan,
      dark: SOLARIZED.base02,
      contrastText: SOLARIZED.base3,
    },
    secondary: {
      main: SOLARIZED.magenta,
      light: SOLARIZED.violet,
      dark: SOLARIZED.base02,
      contrastText: SOLARIZED.base3,
    },
    error: {
      main: SOLARIZED.red,
      light: SOLARIZED.orange,
      dark: SOLARIZED.base02,
      contrastText: SOLARIZED.base3,
    },
    warning: {
      ...
      light: SOLARIZED.orange,
      dark: SOLARIZED.base02,
      contrastText: SOLARIZED.base03,
    },
    info: {
      main: SOLARIZED.cyan,
      light: SOLARIZED.blue,
      dark: SOLARIZED.base02,
      contrastText: SOLARIZED.base3,
    },
    success: {
    ...
    surfaceContainerLowest: SOLARIZED.base03,
    surfaceContainerLow: SOLARIZED.base03,
    surfaceContainer: SOLARIZED.base02,
    surfaceContainerHigh: SOLARIZED.base02,
    surfaceContainerHighest: SOLARIZED.base01,
    surfaceDim: SOLARIZED.base03,
    surfaceBright: SOLARIZED.base02,
...
export const lightThemeOptions: ThemeOptions = {
  ...
  palette: {
    ...
    text: {
      ...
      disabled: SOLARIZED.base1,
    },
    divider: "rgba(88, 110, 117, 0.2)",
    surfaceContainerLowest: SOLARIZED.base3,
    surfaceContainerLow: SOLARIZED.base3,
    surfaceContainer: SOLARIZED.base2,
    surfaceContainerHigh: SOLARIZED.base2,
    surfaceContainerHighest: SOLARIZED.base1,
    surfaceDim: SOLARIZED.base2,
    surfaceBright: SOLARIZED.base3,
    outlineVariant: "rgba(88, 110, 117, 0.2)",
    roles: ROLE_COLORS,
    celestial: CELESTIAL_COLORS,
    flags: FLAG_COLORS,
    action: {
      active: SOLARIZED.base03,
